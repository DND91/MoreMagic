...
{
if (world.getBlockId(j1, k2, j2) != mod_Antartica.ForbiddenPortal.blockID)
{
continue;
}
for (; world.getBlockId(j1, k2 - 1, j2) == mod_Antartica.ForbiddenPortal.blockID; k2--) { }
...
if (world.getBlockId(k1 - 1, l1, i2) == mod_Antartica.ForbiddenPortal.blockID)
{
d2 -= 0.5D;
}
if (world.getBlockId(k1 + 1, l1, i2) == mod_Antartica.ForbiddenPortal.blockID)
...
if (world.getBlockId(k1, l1, i2 - 1) == mod_Antartica.ForbiddenPortal.blockID)
{
d6 -= 0.5D;
}
if (world.getBlockId(k1, l1, i2 + 1) == mod_Antartica.ForbiddenPortal.blockID)
...
boolean flag = j7 < 0;
world.setBlockWithNotify(k8, l9, i11, flag ? mod_Antartica.MysticalStone.blockID : 0);
}
}
}
}
...
world.setBlockWithNotify(l8, i10, j11, flag1 ? mod_Antartica.MysticalStone.blockID : mod_Antartica.ForbiddenPortal.blockID);
}
}
