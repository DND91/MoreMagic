...
{
    /** The magic stack of this EntityMagic. */
    public MagicStack magic;

    /**
     * The age of this EntityMagic (used to animate it up and down as well as expire it)
     */
    public int age;
    public int delayBeforeCanPickup;

    /** The health of this EntityMagic. (For example, damage for tools) */
    private int health;
    public float field_804_d;

    public EntityMagic(World par1World, double par2, double par4, double par6, MagicStack par8MagicStack)
    {
        super(par1World);
        age = 0;
        health = 5;
    ...
    public void writeEntityToNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        par1NBTTagCompound.setCompoundTag("Magic", magic.writeToNBT(new NBTTagCompound()));
    }
    ...
    public void readEntityFromNBT(NBTTagCompound par1NBTTagCompound)
    {
        ...
        NBTTagCompound nbttagcompound = par1NBTTagCompound.getCompoundTag("Magic");
        magic = MagicStack.loadMagicStackFromNBT(nbttagcompound);
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        ...
        int i = magic.stackSize;

        if (delayBeforeCanPickup == 0 && par1EntityPlayer.magicinventory.addMagicStackToInventory(magic))
        {
            if (magic.magicID == Block.wood.blockID)
            {
                par1EntityPlayer.triggerAchievement(AchievementList.mineWood);
            }

            worldObj.playSoundAtEntity(this, "random.pop", 0.2F, ((rand.nextFloat() - rand.nextFloat()) * 0.7F + 1.0F) * 2.0F);
            par1EntityPlayer.onMagicPickup(this, i);
    ...
    /**
     * If returns false, the magic will not inflict any damage against entities.
     */
    public boolean canAttackWithMagic()
    {
        return false;
    }
}
