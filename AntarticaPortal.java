...
public class AntarticaPortal extends BlockBreakable
{
    public AntarticaPortal(int par1, int par2)
    {
    ...
    public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
    {
        ...
        if (par1World.getBlockId(par2 - 1, par3, par4) == mod_Antartica.MysticalStone.blockID || par1World.getBlockId(par2 + 1, par3, par4) == mod_Antartica.MysticalStone.blockID)
        {
            i = 1;
        }
